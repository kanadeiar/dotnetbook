...
В C# доступны дополнительные возвращаемые типы притусловии, что они следуют шаблону с ключевым словом async. В качестве конкретного примера можно назвать тип ValueTask.
